...
export const sidebarGroupLabels: Record<NavGroupId, string> = {
  ...
  "clients-assets": "Clients & Infrastructure",
  "field-ops": "Field Ops",
...
export const frontendRouteMatrix: readonly FrontendRouteMatrixEntry[] = [
  ...
  { path: "/inventory", component: "InventoryWorkspace", authRequired: true, allowedRoles: ["OWNER", "ADMIN", "TECH"], blockedWhenInactive: true, sidebarNavItem: "Infrastructure", mobileSupport: "desktop", serverGate: "requireRole(OWNER,ADMIN,TECH) + tenant-scoped /api/ops + requireNotPaused for writes" },
  { path: "/network", component: "InventoryWorkspace", authRequired: true, allowedRoles: ["OWNER", "ADMIN", "TECH"], blockedWhenInactive: true, sidebarNavItem: "Network", mobileSupport: "desktop", serverGate: "requireRole(OWNER,ADMIN,TECH) + tenant-scoped /api/ops + requireNotPaused for writes" },
  { path: "/documentation", component: "DocumentationWorkspace", authRequired: true, allowedRoles: ["OWNER", "ADMIN", "TECH"], blockedWhenInactive: true, sidebarNavItem: "Documentation", mobileSupport: "desktop", serverGate: "requireRole(OWNER,ADMIN,TECH) + minimum-role filtering + revision audit" },
  { path: "/lifecycle", component: "InventoryWorkspace", authRequired: true, allowedRoles: ["OWNER", "ADMIN", "TECH"], blockedWhenInactive: true, sidebarNavItem: "Lifecycle", mobileSupport: "desktop", serverGate: "requireRole(OWNER,ADMIN,TECH) + tenant-scoped /api/ops + requireNotPaused for writes" },
...
export const sidebarNavItems: readonly SidebarNavItem[] = [
  ...
  { title: "Infrastructure", href: "/inventory", icon: "server", group: "clients-assets", roles: ["OWNER", "ADMIN", "TECH"] },
  { title: "Network", href: "/network", icon: "activity", group: "clients-assets", roles: ["OWNER", "ADMIN", "TECH"] },
  { title: "Documentation", href: "/documentation", icon: "book", group: "clients-assets", roles: ["OWNER", "ADMIN", "TECH"] },
  { title: "Lifecycle", href: "/lifecycle", icon: "key", group: "clients-assets", roles: ["OWNER", "ADMIN", "TECH"] },
